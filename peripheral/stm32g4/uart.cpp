...
void Uart::initDma()
{
  ...
  NVIC_SetPriority(
    ...
    NVIC_EncodePriority(NVIC_GetPriorityGrouping(), init_struct_.txDmaIrqPriority, 0)
  );
...
void Uart::initUart()
{
  ...
  init_struct_.usart->CR3 = USART_CR3_DMAT | USART_CR3_DMAR;
  init_struct_.usart->CR1 = USART_CR1_PCE | USART_CR1_M0 | USART_CR1_FIFOEN | USART_CR1_TE | USART_CR1_RE | USART_CR1_UE;
}
...
void Uart::setTransactionCompletedCallback(transactionCompleteCallback callback, void* param)
{
