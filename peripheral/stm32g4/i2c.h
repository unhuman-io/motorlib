...
class I2C {
 public:
  I2C(I2C_TypeDef &regs, uint16_t speed_khz = 100, float timeout_ms = .1)
      : regs_(regs) {
    switch (speed_khz) {
      case 1000:
      ...
      case 100:
        ...
        // 0xfb << I2C_TIMINGR_SCLL_Pos | 0xa7 << I2C_TIMINGR_SCLH_Pos | 0xa <<
        // I2C_TIMINGR_SCLDEL_Pos | 3 << I2C_TIMINGR_PRESC_Pos; 42.5 MHz, 5.9us
        // low, 3.9 us high, .26 us low stetch
        break;
    }
  ...
  bool tx_ready() const { return regs_.ISR & I2C_ISR_TXE; }
  bool rx_ready() const { return regs_.ISR & I2C_ISR_RXNE; }
  bool transfer_complete() const { return regs_.ISR & I2C_ISR_TC; }
  bool trouble() const {
    return regs_.ISR & (I2C_ISR_NACKF | I2C_ISR_ARLO | I2C_ISR_BERR);
  }

 private:
  void clear_isr() { regs_.ICR |= 0x3F38; }
  float timeout_ms_;
  I2C_TypeDef &regs_;
};
