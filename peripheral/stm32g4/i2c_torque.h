 ...
 public:
  ...
  float read() {
    if (count_ == 0) {
      ...
      if (ready) {
        // process result
        result0_ = (uint32_t)data_in_[3] << 24 | (uint32_t)data_in_[2] << 16 |
                   (uint16_t)data_in_[1] << 8 | data_in_[0];
        result1_ = (uint32_t)data_in_[23] << 24 | (uint32_t)data_in_[22] << 16 |
                   (uint16_t)data_in_[21] << 8 | data_in_[20];
