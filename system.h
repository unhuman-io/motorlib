...
class System {
 public:
    static void run() {
        ...
        api.add_api_variable("add_main_loop_tuning_group", new const APICallback([]()->std::string{
            static bool group_added = false;
            if (!group_added) {
        ...
        api.add_api_variable("sensor_status_group", new const APICallback([]()->std::string{
            static bool group_added = false;
            if (!group_added) {
        ...
        api.add_api_variable("current_status_group", new const APICallback([]()->std::string{
            static bool group_added = false;
            if (!group_added) {
        ...
        api.add_api_variable("current_tuning_group", new const APICallback([]()->std::string{
            static bool group_added = false;
            if (!group_added) {
        ...
        api.add_api_variable("debug_program_group", new const APICallback([]()->std::string{
            static bool group_added = false;
            if (!group_added) {
