...
upgrade_llvm:
	@echo upgrading llvm
	$(SELF_DIR)../scripts/install_llvm.sh

.PHONY: upgrade_llvm

$(SELF_DIR)../llvm/bin/clang:
	$(SELF_DIR)../scripts/install_llvm.sh
endif
...
ifeq ($(CC_MAJOR_VERSION), $(filter $(CC_MAJOR_VERSION),20 21 22))
$(call info_once,clang version $(CC_VERSION))
else
$(error clang version $(CC_VERSION), 20-22 required)
endif
