...
void System::run() {
  ...
  api.add_api_variable(
      "idki_limit", new APIFloat(&actuator_.fast_loop_.foc_->pi_id_.ki_limit_));
  api.add_api_variable(
  ...
  api.add_api_variable(
      "obias", new APIFloat(&actuator_.main_loop_.param_.output_encoder.bias));
  api.add_api_variable("mbias",
                       new APIFloat(&actuator_.main_loop_.motor_encoder_bias_));
  api.add_api_variable(
      "ttgain",
  ...
  api.add_api_variable(
      ...
      new const APIFloat(&actuator_.startup_param_.phase_lock_current));
