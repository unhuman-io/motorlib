...
void pin_config_obot_g474_motor(const BoardRev &board_rev) {
     // Peripheral clock enable
        RCC->APB1ENR1 |= RCC_APB1ENR1_SPI3EN | RCC_APB1ENR1_TIM2EN |  RCC_APB1ENR1_TIM4EN | RCC_APB1ENR1_TIM5EN |
            RCC_APB1ENR1_USBEN | RCC_APB1ENR1_I2C1EN | RCC_APB1ENR1_WWDGEN | RCC_APB1ENR1_RTCAPBEN | RCC_APB1ENR1_PWREN;
        ...
        WWDG->CFR = WWDG_CFR_EWI | 7 << WWDG_CFR_WDGTB_Pos | 0x7f << WWDG_CFR_W_Pos;
