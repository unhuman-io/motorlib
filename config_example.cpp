...
static struct {
  ...
  FastLoopConfig fast_loop = {(float)(1.0 / pwm_frequency), motor_pwm,
                              motor_encoder};
  ...
  MainLoopConfig main_loop = {fast_loop, controller, communication, led,
                              output_encoder};
} config_items;

template <>
ActuatorConfig SystemConfig::actuator_ = {config_items.fast_loop,
                                          config_items.main_loop};
